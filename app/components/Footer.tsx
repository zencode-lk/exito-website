...
export function Footer() {
  ...
  return (
    <footer className="bg-[#1B2E4C] text-white">
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-8 lg:px-20">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <p className="font-caption text-sm text-gray-300">
              Engineering excellence in British Columbia. Innovative design, rigorous compliance, and collaborative expertise.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 font-caption text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:6049911976" className="transition-colors hover:text-[#D05F2A]">
                  (604) 991-1976
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail size={16} className="text-[#D05F2A]" />
                <a href="mailto:engineering@k2ae.ca" className="transition-colors hover:text-[#D05F2A]">
                  engineering@k2ae.ca
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-600 pt-8 text-center font-['Montserrat',_sans-serif] text-sm text-gray-400">
          <p>&copy; {currentYear} K2AE Engineering & Consulting Ltd. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
